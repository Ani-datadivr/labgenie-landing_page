// Country reference for the contact form's country + dial-code comboboxes.
// { name, iso2, dial }. Flags are derived from iso2 at render (regional
// indicator code points) so we don't store emoji literals.
